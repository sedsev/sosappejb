 ...
 */
@Stateless
public class SOSEventTypeFacade extends AbstractFacade<SOSEventType> implements SOSEventTypeFacadeLocal {
    ...
    public SOSEventTypeFacade() {
        super(SOSEventType.class);
    }
