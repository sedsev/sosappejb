 ...
 */
@Stateless
public class ServiceDescriptionFacade extends AbstractFacade<ServiceDescription> implements ServiceDescriptionFacadeLocal {
    ...
    public ServiceDescriptionFacade() {
